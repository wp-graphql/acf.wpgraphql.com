...
function SlackIcon(props) {
  return (
      <svg viewBox="0 0 270 270" aria-hidden="true" {...props} >
            <g>
                <g>
                    <path className="st0"
                          d="M99.4,151.2c0,7.1-5.8,12.9-12.9,12.9s-12.9-5.8-12.9-12.9c0-7.1,5.8-12.9,12.9-12.9h12.9V151.2z"/>
                    <path className="st0" d="M105.9,151.2c0-7.1,5.8-12.9,12.9-12.9s12.9,5.8,12.9,12.9v32.3c0,7.1-5.8,12.9-12.9,12.9
                ...
                <g>
                    ...
                    <path className="st0" d="M118.8,105.9c7.1,0,12.9,5.8,12.9,12.9s-5.8,12.9-12.9,12.9H86.5c-7.1,0-12.9-5.8-12.9-12.9
                ...
                <g>
                    ...
                    <path className="st0" d="M164.1,118.8c0,7.1-5.8,12.9-12.9,12.9c-7.1,0-12.9-5.8-12.9-12.9V86.5c0-7.1,5.8-12.9,12.9-12.9
                        c7.1,0,12.9,5.8,12.9,12.9V118.8z"/>
                </g>
                <g>
                    <path className="st0"
                          d="M151.2,170.6c7.1,0,12.9,5.8,12.9,12.9c0,7.1-5.8,12.9-12.9,12.9c-7.1,0-12.9-5.8-12.9-12.9v-12.9H151.2z"/>
                    <path className="st0" d="M151.2,164.1c-7.1,0-12.9-5.8-12.9-12.9c0-7.1,5.8-12.9,12.9-12.9h32.3c7.1,0,12.9,5.8,12.9,12.9
...
function SocialLink({ href, icon: Icon, children }) {
  return (
    <Link href={href} className="group">
      ...
      <Icon className="h-5 w-5 fill-blue-300 transition group-hover:fill-blue-900 dark:group-hover:fill-blue-500" />
    </Link>
  )
}
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink href="https://twitter.com/@wpgraphql" icon={TwitterIcon}>
          Follow us on Twitter
        </SocialLink>
        <SocialLink href="https://github.com/wp-graphql/wpgraphql-acf" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
